                    ...
                    <table class="table">
                        <tbody class="t-control">
                            <tr>
                                ...
                                <td><input class="form-control input-sm" name="writer" value="${sessionScope.userVO.userId}"><span id="msgId"></span></td>                                
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                <textarea class="form-control" rows="7" name="content"></textarea><span id="msgContent"></span>
                                </td>                 
                            </tr>
                        </tbody>
                    </table>
